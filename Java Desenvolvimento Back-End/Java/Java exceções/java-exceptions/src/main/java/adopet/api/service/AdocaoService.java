...
public class AdocaoService {
    ...
    public void solicitar(SolicitacaoDeAdocaoDTO dto) {
        ...
        //Pet com solicitacoes de adocao em andamento
        ...
        if(petAdocaoEmAndamento){
            throw new AdocaoException("Pet com solicitacoes de adocao em andamento");
        }
        //Tutor com 2 adocoes aprovadas
        Integer tutorAdocoesAprovadas = adocaoRepository.countByTutorIdAndStatus(dto.idTutor(), StatusAdocao.APROVADO);
        if(tutorAdocoesAprovadas >= 2){
            throw new AdocaoException("Tutor com o maximo de adocões");
        }
